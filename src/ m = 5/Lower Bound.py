...
def implementation(cs, Plogit):
    ...
    Returns:
        list: A list of dictionaries containing the lower-bound values for all inventory states at day 0.
    """
    ...
    for z in range(0, 100):
        LBV = BackwardInduction(cs=cs, T= length[z], sample=RemAge[z])
        Dic = {'LBV': LBV}
        res_list.append(Dic)
    return (res_list)
...
if __name__ ==  '__main__':
    ...
    open_file = open("InfoRelaxRandHorizonLength_m5_Rep3100.pkl", "wb")
