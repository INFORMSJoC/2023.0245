...
df <- read.csv('ADPerf_m5_RelGap.csv') 
...
df$Endog. = factor(df$Endog., levels = c("[1.6, 2.6, 2.8, 1.6, 0.0, 0.0, 0.0, 0.0]", "[1.9, 3.1, 3.1, 2.5, 0.0, 0.0, 0.0, 0.0]",
...
df <- read.csv('ADPerf_m5_DemSens_RelGap.csv') 
...
df3$Endog. = mapvalues(df3$Endog., from = c("[1.6, 2.6, 2.8, 1.6, 0.0, 0.0, 0.0, 0.0]", "[1.9, 3.1, 3.1, 2.5, 0.0, 0.0, 0.0, 0.0]",
                                            "[1.9, 3.1, 3.1, 2.5, -0.03, -0.06, -0.03, -0.09]", "[1.9, 3.1, 3.1, 2.5, -0.03, -0.06, -0.08, -0.09]",
                                            "[1.9, 3.1, 3.1, 2.5, -0.05, -0.1, -0.15, -0.2]", "[1.9, 3.1, 3.1, 2.5, -0.1, -0.2, -0.3, -0.4]"), 
                       to = c("Exogenous", "(1.9, 3.1, 3.1, 2.5)\n(0.0, 0.0, 0.0, 0.0)", 
...
# Filter data
df3 = df3[which(!df3$Endog.%in% c("(1.9, 3.1, 3.1, 2.5)\n(0.0, 0.0, 0.0, 0.0)")),]

# Add scaling values
df3$scale = c(rep(30, 5*11), rep(30, 5*11), rep(30, 5*11), rep(30, 5*11), rep(30, 5*11), rep(30, 5*11))
...
ggsave("Figure EC.3.pdf", width = 22, height = 19, units = "in")
